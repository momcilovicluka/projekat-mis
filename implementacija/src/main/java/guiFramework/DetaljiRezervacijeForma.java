...
public class DetaljiRezervacijeForma {
	...
	private void initialize() {
		...
		frmIzdavanjeRezervacije.setIconImage(Toolkit.getDefaultToolkit().getImage(DetaljiRezervacijeForma.class.getResource("/guiFramework/book-stack.png")));
		...
		lblDatum.setBounds(10, 87, 159, 21);
