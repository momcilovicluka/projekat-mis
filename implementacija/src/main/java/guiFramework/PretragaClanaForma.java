...
public class PretragaClanaForma {
	...
	private void initialize() {
		...
		frmPretragaClanova.setIconImage(Toolkit.getDefaultToolkit().getImage(PretragaClanaForma.class.getResource("/guiFramework/book-stack.png")));
		...
		btnOdaberi.setBounds(159, 232, 106, 23);
